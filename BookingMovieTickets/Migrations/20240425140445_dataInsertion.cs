...
values: new object[,]
{
    ...
    {34,1,"A01-34", false}, {35,1,"A01-35", false}, {36,1,"A01-36", false}, {37,2,"A01-37", false},{38,1,"A01-38", false},
    ...
    {446,10,"A10-41",false },{447,10,"A10-42",false },{448,10,"A10-43",false },{449,10,"A10-44",false },{450,10,"A10-45",false }
            ...
            migrationBuilder.InsertData(
                table: "Films",
                columns: new[] { "FilmId", "NameFilm", "Description", "PosterUrl", "TrailerUrl", "PremiereDate",
    ...
    {1, "LẬT MẶT 7: MỘT ĐIỀU ƯỚC",
        ...
        "https://youtu.be/d1ZHdosjNX8?si=f6_pea9cJ5HtvnJy",
         new DateTime(2024,4,26,0,0,0),"Lý Hải","Tiếng Việt - Phụ đề Tiếng Anh","K - Phim được phổ biến đến người xem dưới 13 tuổi và có người bảo hộ đi kèm",138,"Thanh Hiền, Trương Minh Cường, Đinh Y Nhung, Quách Ngọc Tuyên, Trâm Anh, Trần Kim Hải,...",12},
    ...
    new DateTime(2024,3,29,0,0,0),"Adam Wingard","Tiếng Anh - Phụ đề Tiếng Việt, Tiếng Hàn","K - Phim được phổ biến đến người xem dưới 13 tuổi và có người bảo hộ đi kèm",115,"Rebecca Hall; Brian Tyree Henry; Dan Stevens; Kaylee Hottle; Alex Ferns; Fala Chen,...",1},
    ...
    new DateTime(2024,3,8,0,0,0),"Mike Mitchell","Tiếng Anh - Phụ đề Tiếng Việt; Lồng tiếng","P - Phim được phép phổ biến đến người xem ở mọi độ tuổi.",94,"Jack Black, Dustin Hoffman, James Hong, Awkwafina, ...",7},
    ...
    new DateTime(2024,4,12,0,0,0),"Fujii Michihito","Tiếng Nhật & Tiếng Trung Quốc với phụ đề Tiếng Việt và Tiếng Anh","T13 - Phim được phổ biến đến người xem từ đủ 13 tuổi trở lên (13+)",123," Greg Hsu, Kaya Kiyohara, Chang Chen, Kuroki Hitomi, Michieda Shunsuke,...",9},
    ...
    new DateTime(2024,3,15,0,0,0),"Jang Jae Hyun","Tiếng Hàn - Phụ đề Tiếng Anh & Tiếng Việt","T16 - Phim được phổ biến đến người xem từ đủ 16 tuổi trở lên (16+)",133,"Choi Min Sik, Yoo Hai Jin, Kim Go Eun, Lee Do Hyun,...",4},
    ...
    new DateTime(2024,7,5,0,0,0),"Chris Renaud","Tiếng Anh - Phụ đề Tiếng Việt; Lồng tiếng","PG - Cha mẹ nên có hướng dẫn cho con khi xem ",0,"Steve Carell, Kristen Wiig, Joey King,...",7},
    ...
    new DateTime(2024,5,24,0,0,0),"Kazuaki Imai","Tiếng Nhật - Phụ đề Tiếng Việt; Lồng tiếng","G - Phim dành cho mọi lứa tuổi",115,"Wasabi Mizuta, Megumi Ôhara, Yumi Kakazu...",7},
    ...
    new DateTime(2024,5,3,0,0,0),"Spenser Cohen","Tiếng Anh - Phụ đề Tiếng Việt","T18 - Phim được phổ biến đến người xem từ đủ 18 tuổi trở lên (18+)",160,"Avantika, Jacob Batalon, Olwen Fouéré,...",4},
    ...
    new DateTime(2024,4,19,0,0,0),"Nguyễn Ngọc Lâm","Tiếng Việt - Phụ đề Tiếng Anh","T18 - Phim được phổ biến đến người xem từ đủ 18 tuổi trở lên (18+)",115," Xuân Lan, Thái Hoà, Lâm Thanh Nhã, Uyển Ân, Hữu Châu, Trâm Anh, Trương Thanh Long, Quang Minh, Bé Quyên,...",9},
   ...
   new DateTime(2024,2,10,0,0,0),"Trấn Thành","Tiếng Việt - Phụ đề Tiếng Anh","T18 - Phim được phổ biến đến người xem từ đủ 18 tuổi trở lên (18+)",131,"Phương Anh Đào, Tuấn Trần, Trấn Thành, Uyển Ân, Hồng Đào, NSND Việt Anh, NSND Ngọc Giàu, Khả Như, Quốc Khánh, Anh Thư, Lý Hạo Mạnh Quỳnh, Anh Đức, Anh Phạm, Lộ Lộ, Kiều Linh, Ngọc Nga, Thanh Hằng, Ngọc Nguyễn, Hoàng Mèo, Mạnh Lân,...",6},
    ...
    new DateTime(2024,4,26,0,0,0),"Alex Garland","Tiếng Anh - Phụ đề Tiếng Việt","T18 - Phim được phổ biến đến người xem từ đủ 18 tuổi trở lên (18+)",109,"Kirsten Dunst, Wagner Moura, Cailee Spaeny,…",1},
    ...
    new DateTime(2024,4,18,0,0,0),"Enrico Casarosa","Tiếng Anh với phụ đề tiếng Việt, lồng tiếng","P - Phim được phép phổ biến đến người xem ở mọi độ tuổi.",99,"(Lồng tiếng): Jacob Tremblay, Jack Dylan Grazer, Emma Berman, Saverio Raimondo, Maya Rudolph, Marco Barricelli, Jim Gaffigan, Sandy Martin,...",7}
                });
            migrationBuilder.InsertData(
               table: "PremiereTime",
               columns: new[] { "PremiereTimeId", "StartTime", "FilmId" },
               values: new object[,]
               {
               {1,new DateTime(2024, 4, 26, 10, 15, 0),1 },
               {2,new DateTime(2024,3,29,15,35,0),2 },
               {3,new DateTime(2024,3,8,19,35,0),3},
               {4,new DateTime(2024,4,12,16,25,0),4},
               {5,new DateTime(2024,3,15,17,55,0),5},
               {6,new DateTime(2024,7,5,18,35,0),6},
               {7,new DateTime(2024,5,24,20,55,0),7},
               {8,new DateTime(2024,5,3,22,35,0),8},
               {9,new DateTime(2024,4,29,13,25,0),9},
               {10,new DateTime(2024,2,10,15,30,0),10},
               {11,new DateTime(2024,4,12,17,30,0),11},
               {12,new DateTime(2024,4,18,14,45,0),12}
               }
            );
            migrationBuilder.InsertData(
                table: "FilmsSchedule",
