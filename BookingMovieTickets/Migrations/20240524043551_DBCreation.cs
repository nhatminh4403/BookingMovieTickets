...
namespace BookingMovieTickets.Migrations
{
    ...
    public partial class DBCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ScheduleDescriptions",
                columns: table => new
                {
                    ScheduleDescriptionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Description = table.Column<TimeSpan>(type: "time", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleDescriptions", x => x.ScheduleDescriptionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FilmSchedules_ScheduleDescriptions_ScheduleDescriptionId",
                        column: x => x.ScheduleDescriptionId,
                        principalTable: "ScheduleDescriptions",
                        principalColumn: "ScheduleDescriptionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilmSchedules_ScheduleDescriptionId",
                table: "FilmSchedules",
                column: "ScheduleDescriptionId");
