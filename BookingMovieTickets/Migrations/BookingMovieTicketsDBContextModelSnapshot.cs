...
namespace BookingMovieTickets.Migrations
{
    ...
    partial class BookingMovieTicketsDBContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingMovieTickets.Models.Film", b =>
                {
            ...
            modelBuilder.Entity("BookingMovieTickets.Models.FilmCategory", b =>
                {
                    b.Property<int>("FilmCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookingMovieTickets.Models.FilmSchedule", b =>
                {
            ...
            modelBuilder.Entity("BookingMovieTickets.Models.ScheduleDescription", b =>
                {
                    b.Property<int>("ScheduleDescriptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookingMovieTickets.Models.Theatre", b =>
                {
            ...
            modelBuilder.Entity("BookingMovieTickets.Models.TheatreRoom", b =>
                {
                    b.Property<int>("TheatreRoomId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookingMovieTickets.Models.UserInfo", b =>
                {
            ...
            modelBuilder.Entity("BookingMovieTickets.Models.Film", b =>
                {
                    b.HasOne("BookingMovieTickets.Models.FilmCategory", "FilmCategory")
                        .WithMany("Film")
            ...
            modelBuilder.Entity("BookingMovieTickets.Models.FilmSchedule", b =>
                {
                    ...
                    b.HasOne("BookingMovieTickets.Models.ScheduleDescription", "ScheduleDescription")
                        .WithMany("FilmSchedules")
                        .HasForeignKey("ScheduleDescriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookingMovieTickets.Models.TheatreRoom", "TheatreRoom")
                        .WithMany("FilmSchedules")
            ...
            modelBuilder.Entity("BookingMovieTickets.Models.Receipt", b =>
                {
                    b.HasOne("BookingMovieTickets.Models.UserInfo", "User")
                        .WithMany("Receipts")
            ...
            modelBuilder.Entity("BookingMovieTickets.Models.TheatreRoom", b =>
                {
                    b.HasOne("BookingMovieTickets.Models.Theatre", "Theatre")
            ...
            modelBuilder.Entity("BookingMovieTickets.Models.TicketCart", b =>
                {
                    b.HasOne("BookingMovieTickets.Models.UserInfo", "UserInfo")
                        .WithOne("TicketCart")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookingMovieTickets.Models.UserInfo", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
